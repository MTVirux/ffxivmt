...
ACTION_FILES_TO_TRACK=($SALES_ADD_LOG_FILE $LISTINGS_ADD_LOG_FILE $LISTINGS_REMOVE_LOG_FILE $EXTERNAL_COM_LOG)
ERROR_FILES_TO_TRACK=($SALES_ADD_ERROR_LOG_FILE $LISTINGS_ADD_ERROR_LOG_FILE $LISTINGS_REMOVE_ERROR_LOG_FILE)
