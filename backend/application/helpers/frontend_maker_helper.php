...
function get_navbar($navbar_structure){
    ...
    <a class="navbar-brand" href="'.base_url("").'">FFMT</a>
    ...
    <ul class="navbar-nav">';
      ...
      foreach($navbar as $key => $value){
        if(gettype($value) == "array"){
          ...
          $navbar_html .= '<li class="nav-item"> <a class="nav-link" href="'.base_url($value).'">'.$key.'</a> </li>';
        }
      }
...
function get_navbar_handle_array($input){
  ...
  foreach($input as $key => $value){
    if(gettype($value) == "array"){
      ...
      $navbar_html .= '<li> <a class="dropdown-item" href="'.base_url($value).'">'.$key.'</a> </li>';
    }
  }
